...
@property (nonatomic, strong) RBScrollView *scrollView;
...
@implementation RBSegmentedControl
...
- (id)initWithSectionTitles:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.type = RBSegmentedControlTypeText;
    }
...
- (id)initWithSectionImages:(NSArray*)sectionImages sectionSelectedImages:(NSArray*)sectionSelectedImages {
    ...
    if (self) {
        ...
        self.type = RBSegmentedControlTypeImages;
    }
...
- (instancetype)initWithSectionImages:(NSArray *)sectionImages sectionSelectedImages:(NSArray *)sectionSelectedImages titlesForSections:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.sectionSelectedImages = sectionSelectedImages;
		self.sectionTitles = sectiontitles;
        self.type = RBSegmentedControlTypeTextImages;
    }
...
- (void)commonInit {
    self.scrollView = [[RBScrollView alloc] init];
    ...
    self.selectionStyle = RBSegmentedControlSelectionStyleTextWidthStripe;
    self.selectionIndicatorLocation = RBSegmentedControlSelectionIndicatorLocationUp;
    self.segmentWidthStyle = RBSegmentedControlSegmentWidthStyleFixed;
...
- (void)setSelectionIndicatorLocation:(RBSegmentedControlSelectionIndicatorLocation)selectionIndicatorLocation {
	_selectionIndicatorLocation = selectionIndicatorLocation;
	
	if (selectionIndicatorLocation == RBSegmentedControlSelectionIndicatorLocationNone) {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == RBSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight)/2 - stringHeight/2 + ((self.selectionIndicatorLocation == RBSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
            
            CGRect rect;
            if (self.segmentWidthStyle == RBSegmentedControlSegmentWidthStyleFixed) {
                rect = CGRectMake((self.segmentWidth * idx) + (self.segmentWidth - stringWidth)/2, y, stringWidth, stringHeight);
            } else if (self.segmentWidthStyle == RBSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == RBSegmentedControlTypeImages) {
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            UIImage *icon = iconImage;
            CGFloat imageWidth = icon.size.width;
            CGFloat imageHeight = icon.size.height;
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2 - imageHeight / 2 + ((self.selectionIndicatorLocation == RBSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
    ...
    } else if (self.type == RBSegmentedControlTypeTextImages){
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
    ...
    if (self.selectedSegmentIndex != RBSegmentedControlNoSegment) {
        if (self.selectionStyle == RBSegmentedControlSelectionStyleArrow) {
            ...
            if (!self.selectionIndicatorStripLayer.superlayer) {
                ...
                if (self.selectionStyle == RBSegmentedControlSelectionStyleBox && !self.selectionIndicatorBoxLayer.superlayer) {
...
- (void)setArrowFrame {
    ...
    if (self.selectionIndicatorLocation == RBSegmentedControlSelectionIndicatorLocationDown) {
    ...
    if (self.selectionIndicatorLocation == RBSegmentedControlSelectionIndicatorLocationUp) {
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == RBSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == RBSegmentedControlSelectionStyleTextWidthStripe &&
            sectionWidth <= self.segmentWidth &&
            self.segmentWidthStyle != RBSegmentedControlSegmentWidthStyleDynamic) {
            CGFloat widthToEndOfSelectedSegment = (self.segmentWidth * self.selectedSegmentIndex) + self.segmentWidth;
            CGFloat widthToStartOfSelectedIndex = (self.segmentWidth * self.selectedSegmentIndex);
            ...
            if (self.segmentWidthStyle == RBSegmentedControlSegmentWidthStyleDynamic) {
...
- (void)updateSegmentsRects {
    ...
    if (self.type == RBSegmentedControlTypeText && self.segmentWidthStyle == RBSegmentedControlSegmentWidthStyleFixed) {
    ...
    } else if (self.type == RBSegmentedControlTypeText && self.segmentWidthStyle == RBSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == RBSegmentedControlTypeTextImages && RBSegmentedControlSegmentWidthStyleFixed){
    ...
    } else if (self.type == RBSegmentedControlTypeTextImages && RBSegmentedControlSegmentWidthStyleDynamic) {
        NSMutableArray *mutableSegmentWidths = [NSMutableArray array];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint(self.bounds, touchLocation)) {
        ...
        NSUInteger sectionsCount = 0; //2015-04-04 11:08 By zruibin
        
        if (self.type == RBSegmentedControlTypeImages) {
            sectionsCount = [self.sectionImages count];
        } else if (self.type == RBSegmentedControlTypeTextImages || self.type == RBSegmentedControlTypeText) {
...
- (void)setSelectedSegmentIndex:(NSUInteger)index animated:(BOOL)animated notify:(BOOL)notify {
    ...
    if (index == RBSegmentedControlNoSegment) {
        ...
        if (animated) {
            ...
            if(self.selectionStyle == RBSegmentedControlSelectionStyleArrow) {
                ...
                if ([self.selectionIndicatorStripLayer superlayer] == nil) {
                    ...
                    if (self.selectionStyle == RBSegmentedControlSelectionStyleBox && [self.selectionIndicatorBoxLayer superlayer] == nil)
                        [self.scrollView.layer insertSublayer:self.selectionIndicatorBoxLayer atIndex:0];
