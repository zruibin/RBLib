...
#import <UIImageView+WebCache.h> /* 2015-05-09 By zruibin*/
...
//            imageView.frame = CGRectMake(0, 0, scroll.bounds.size.width, self.image.size.height);
            #pragma mark - 2015-04-15 by zruibin
            imageView.frame = CGRectMake(0, 0, scroll.bounds.size.width, scroll.bounds.size.height);
...
//    _scroll.contentSize = CGSizeMake(0, self.image.size.height);
    if (self.image.size.height > self.bounds.size.height) {
        _scroll.contentSize = CGSizeMake(0, self.bounds.size.height);
    } else {
        _scroll.contentSize = CGSizeMake(0, self.image.size.height);
    }
}
