...
//  RBLib
//
//  Created by Ruibin.Chow on 16/9/6.
//  Copyright © 2016年 Ruibin.Chow. All rights reserved.
//

#import "RBGCDTimer.h"

@interface RBGCDTimer ()
...
@implementation RBGCDTimer

#pragma mark - Public Method

+ (RBGCDTimer *)sharedInstance
{
    static RBGCDTimer *gcdTimer = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        gcdTimer = [[RBGCDTimer alloc] init];
    });
...
- (void)scheduledDispatchTimerWithName:(NSString *)timerName
                          ...
                          actionOption:(RBActionOption)option
